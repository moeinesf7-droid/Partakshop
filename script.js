...
function renderProducts(){
  ...
  document.getElementById("grid").innerHTML=list.map(p=>`
    <article class="card">
      ...
      <button
        class="fav"
        onclick="toggleFav('${String(p.name).replace(/'/g,"\\'")}')"
      >
        ${fav.includes(p.id)?"♥":"♡"}
      </button>
